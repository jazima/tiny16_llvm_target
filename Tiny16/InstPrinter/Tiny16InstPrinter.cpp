...
#include "Tiny16GenAsmWriter.inc"

void Tiny16InstPrinter::printRegName(raw_ostream &OS, MCRegister Reg) {
  OS << StringRef(getRegisterName(Reg)).lower();
}

void Tiny16InstPrinter::printInst(const MCInst *MI, uint64_t Address, StringRef Annot,
...
void Tiny16InstPrinter::printCondCode(const MCInst *MI, unsigned OpNum,
                                   raw_ostream &O) {
...
void Tiny16InstPrinter::printAddrModeMemSrc(const MCInst *MI, unsigned OpNum,
                                         raw_ostream &O) {
...
void Tiny16InstPrinter::printOperand(const MCInst *MI, unsigned OpNo,
                                  raw_ostream &O) {
